...
knitr::kable(tidy_disc1,
             caption = "Statistics for the Dataset, tidy_disc1")
...
knitr::kable(tidy_disc2,
             caption = "Statistics for the Dataset, tidy_disc2") 
...
ggplot(safe_organized) +
  ...
  theme_minimal() +
  labs(x = "School Urbanness Category", 
       y = "Number of Schools That Provide Teacher Training on Positive Behavioral Intervention",
       title = "The Provision of Teacher Training on Classroom Management by Urbanness and Enrollment of School",
       tag = "(9)",
       fill = "Classroom Management 
